...
file = open("/Users/aleksejfilobok/PycharmProjects/CALab1/fortest.txt", 'r')
asd = file.read()
...
urls = find_by_tag('url', "/Users/aleksejfilobok/PycharmProjects"
                          "/CALab1/sportnews.xml")


class test_single_thread(unittest.TestCase):
    def test_find_by_tag(self):
        self.assertEqual(find_by_tag('url', "/Users/aleksejfilobok"
                                            "/PycharmProjects"
                                            "/CALab1/sportnews.xml"),
